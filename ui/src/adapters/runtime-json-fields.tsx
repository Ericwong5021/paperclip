...
export function RuntimeServicesJsonField({
  ...
  return (
    <Field label={t("adapterTranscript.runtimeServicesJson")} hint={help.runtimeServicesJson}>
      <textarea
...
export function PayloadTemplateJsonField({
  ...
  return (
    <Field label={t("adapterTranscript.payloadTemplateJson")} hint={help.payloadTemplateJson}>
      <textarea
