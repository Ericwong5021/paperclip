...
export const ChatComposer = forwardRef<ChatComposerHandle, ChatComposerProps>(function ChatComposer(
  {
    ...
    onChange,
    onSubmit,
    placeholder = t("interactions.chatMessagePlaceholder"),
    disabled = false,
    submitting = false,
    submitKey = "mod-enter",
    singleLine = false,
    ...
    surface = "card",
    autoFocus = false,
    sendLabel = t("interactions.chatSendMessage"),
    onAttachFiles,
    attachments = [],
    attaching = false,
    acceptFileTypes,
      ...
      {isDragOver && canAttach ? (
        ...
        >
          <span className="inline-flex items-center gap-2">
            ...
            {t("interactions.chatDropToAttach")}
          </span>
        </div>
      ) : null}
            ...
            const statusLabel =
              attachment.status === "uploading"
                ...
                : attachment.status === "error"
                  ...
                  : attachment.inline
                    ? t("interactions.chatInsertedInline")
        ...
        {canAttach ? (
          <>
            ...
            <button
              ...
              aria-label={t("interactions.chatAttachFiles")}
              title={t("interactions.chatAttachFiles")}
