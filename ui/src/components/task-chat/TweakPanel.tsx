  ...
  return (
    ...
    >
      ...
      >
        ...
        <span>{t("interactions.chatMotionPanel")}</span>
        <div className="ml-auto flex items-center gap-1">
          <button type="button" title={t("interactions.chatResetAll")} onClick={resetAll} className="rounded p-0.5 hover:bg-accent">
            <RotateCcw className="h-3.5 w-3.5" />
          </button>
          <button
            type="button"
            title={minimized ? t("interactions.chatExpand") : t("interactions.chatMinimize")}
