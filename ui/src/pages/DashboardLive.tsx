...
export function DashboardLive() {
  ...
  useEffect(() => {
    setBreadcrumbs([
      { label: t("dashboardLive.dashboard"), href: "/dashboard" },
  ...
  return (
    <div className="space-y-5">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        ...
        <div className="text-sm text-muted-foreground">{t("dashboardLive.showing", { count: DASHBOARD_LIVE_RUN_LIMIT })}</div>
      </div>
      ...
      <ActiveAgentsPanel
        ...
        emptyMessage={t("dashboardLive.empty")}
