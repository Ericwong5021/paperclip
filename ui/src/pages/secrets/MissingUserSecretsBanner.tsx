...
export function MissingUserSecretsBanner({
  ...
  useTranslation();
  const effectiveTitle = title ?? t("forms.userSecrets.title");
      ...
      <div className="flex items-start gap-2">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-0.5 text-amber-700/90 dark:text-amber-300/90">
            {t(missing.length === 1 ? "forms.userSecrets.oneMissing" : "forms.userSecrets.manyMissing", { count: missing.length })}
          </p>
